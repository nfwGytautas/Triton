...
DXRenderer* DXContext::dx_renderer()
{
	return static_cast<Triton::PType::DXRenderer*>(renderer);
}

DXFactory* DXContext::dx_factory()
{
...
void Triton::PType::DXContext::setViewPort(int x, int y, int width, int height)
{
 ...
 void Triton::PType::DXContext::fillPacket(PlatformObject* packet)
{
...
void Triton::PType::DXContext::depthBufferState(bool state)
{
	if (state)
	{
		m_deviceContext->OMSetDepthStencilState(m_depthStencilState, 1);
