...
void Triton::Systems::BatchSystem::OnUpdate(Triton::ECS::Registry& aRegistry, float aDelta)
{
	...
	aRegistry.view<Components::Transform, Components::MeshFilter, Components::MeshRenderer>().each(
	[&](const auto entity, auto &transform, auto &meshFilter, auto& meshRenderer) {	
